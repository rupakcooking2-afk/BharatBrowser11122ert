...
def main(
    ...
    """Bharat Browser Build System - Modular pipeline executor

    Build Bharat Browser using phase flags (auto-ordered), explicit modules, or configs.
    ...
    log_info("🚀 Bharat Browser Build System")
    log_info("=" * 70)
