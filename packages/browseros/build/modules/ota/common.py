...
<rss xmlns:sparkle="http://www.andymatuschak.org/xml-namespaces/sparkle" version="2.0">
  <channel>
    ...
    <description>Bharat Browser Server binary updates</description>
...
def generate_server_appcast(
    ...
    """
    if channel == "alpha":
        title = "Bharat Browser Server (Alpha)"
        appcast_url = "https://cdn.bharatbrowser.com/appcast-server.alpha.xml"
    else:
        title = "Bharat Browser Server"
        appcast_url = "https://cdn.bharatbrowser.com/appcast-server.xml"
