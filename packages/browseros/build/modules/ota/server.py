#!/usr/bin/env python3
"""Server OTA module for Bharat Browser Server binary updates"""
...
class ServerOTAModule(CommandModule):
    ...
    requires = []
    description = "Create and upload Bharat Browser Server OTA update"
    ...
    def execute(self, context: Context) -> None:
        ctx = context
        log_info(f"\n🚀 Bharat Browser Server OTA v{self.version} ({self.channel})")
        log_info("=" * 70)
