...
DOWNLOAD_PATH_MAPPING = {
    "macos": {
        "arm64": "download/BharatBrowser-arm64.dmg",
        "x64": "download/BharatBrowser-x86_64.dmg",
        "universal": "download/BharatBrowser.dmg",
    },
    "win": {
        "x64_installer": "download/BharatBrowser_installer.exe",
    },
    "linux": {
        "x64_appimage": "download/BharatBrowser.AppImage",
        "x64_deb": "download/BharatBrowser.deb",
        "arm64_appimage": "download/BharatBrowser-arm64.AppImage",
        "arm64_deb": "download/BharatBrowser-arm64.deb",
    },
}
...
def generate_release_notes(version: str, metadata: Dict[str, Dict]) -> str:
    ...
    notes = f"""## Bharat Browser v{version}
