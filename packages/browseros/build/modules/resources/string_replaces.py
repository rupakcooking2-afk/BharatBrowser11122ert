#!/usr/bin/env python3
"""String replacement module for Bharat Browser build system"""
...
branding_replacements = [
    (
        ...
        r"The Bharat Browser Authors. All rights reserved.",
    ),
    (
        r"Google LLC. All rights reserved.",
        r"The Bharat Browser Authors. All rights reserved.",
    ),
    (r"The Chromium Authors", r"Bharat Browser Software Inc"),
    (r"Google Chrome", r"Bharat Browser"),
    (r"(Google)(?! Play)", r"Bharat Browser"),
    (r"Chromium", r"Bharat Browser"),
    (r"Chrome", r"Bharat Browser"),
]
